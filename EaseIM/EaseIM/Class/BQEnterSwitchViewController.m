...
- (void)switchAction {
    if (self.aSwitch.isOn) {
        [EMDemoOptions sharedOptions].isJiHuApp = YES;
        self.titleLabel.text = @"极狐App";
    }else {
        [EMDemoOptions sharedOptions].isJiHuApp = NO;
        self.titleLabel.text = @"运管App";
    }
...
- (void)loginButtonAction {
    ...
    [[BQAppStyle shareAppStyle] updateNavAndTabbarWithIsJihuApp:[EMDemoOptions sharedOptions].isJiHuApp];
    
    [EaseIMKitManager.shared configuationIMKitIsJiHuApp:[EMDemoOptions sharedOptions].isJiHuApp];
