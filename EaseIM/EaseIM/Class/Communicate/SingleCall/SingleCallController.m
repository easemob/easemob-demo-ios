...
{
    EMTextMessageBody *body = [[EMTextMessageBody alloc] initWithText:@"您有一个通话邀请"];
    EMMessage *message = [[EMMessage alloc]initWithConversationID:aSession.localName from:aSession.remoteName to:aSession.localName body:body ext:nil];
    message.chatType = EMChatTypeChat;
    [EMRemindManager remindMessage:message];
    ...
    @synchronized (_callLock) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            if (self.currentController) {
                ...
                [rootViewController presentViewController:self.currentController animated:YES completion:nil];
            ...
            @synchronized (self.callLock) {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if (strongSelf.currentController) {
                        ...
                        [rootViewController presentViewController:strongSelf.currentController animated:YES completion:nil];
                    }
                });
            }
                ...
                reason:(EMCallEndReason)aReason
{
    ...
    @synchronized (_callLock) {
        ...
        [self.currentController dismissViewControllerAnimated:YES completion:^{
            weakSelf.currentController = nil;
        }];
