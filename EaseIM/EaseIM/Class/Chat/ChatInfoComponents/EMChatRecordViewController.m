...
- (void)searchBarSearchButtonClicked:(NSString *)aString
{
    ...
    [self.conversation loadMessagesWithKeyword:aString timestamp:0 count:50 fromUser:nil searchDirection:EMMessageSearchDirectionDown /*scope:EMMessageSearchScopeContent*/ completion:^(NSArray *aMessages, EMError *aError) {
