...
public class CompositeInputView: UIView {
    ...
    private lazy var leftButton: UIButton = {
        ...
        button.setImage(UIImage(named: "phone in circle"), for: .normal)
    ...
    init(frame: CGRect, type: ChatType) {
        self.chatType = type
    ...
    private func setupConstraints() {
        ...
        self.rightButton.setImage(UIImage(named: "wave_in_circle" ), for: .normal)
    }
...
extension CompositeInputView: UITextViewDelegate {
    ...
    public func textViewShouldBeginEditing(_ textView: UITextView) -> Bool {
        self.rightButton.setImage(UIImage(named: "forbidden_send"), for: .normal)
        return true
    }
    ...
    public func textView(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        ...
        let fullText = text.chat.replaceStringWithRange(location: range.location, length: range.length, newString: text)
        if fullText.count > 300 {
            textView.text = fullText.chat.subStringTo(300)
            return false
        }
        if self.textView.text.isEmpty {
            self.rightButton.setImage(UIImage(named: "forbidden_send"), for: .normal)
        } else {
            self.rightButton.setImage(UIImage(named: "send"), for: .normal)
        }
        return true
    }
