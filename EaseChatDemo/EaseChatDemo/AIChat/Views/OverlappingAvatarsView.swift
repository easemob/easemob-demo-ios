...
public class OverlappingAvatarsView: UIImageView {
    ...
    func refresh(with urls: (String, String)) {
        self.image = nil
        self.cornerRadius(0)
        self.avatarView1.sd_setImage(with: URL(string: urls.0), placeholderImage: UIImage(named: "botavatar"))
        self.avatarView2.sd_setImage(with: URL(string: urls.1), placeholderImage: UIImage(named: "botavatar"))
        let avatarWidth = self.containerView.frame.width*0.72
