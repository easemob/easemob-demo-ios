    ...
    override func viewDidLoad() {
        ...
        self.fraudView.closeClosure = { [weak self] in
            ...
            UIView.animate(withDuration: 0.22) {
                self.messageContainer.resetFrame(newFrame: CGRect(x: 0, y: self.navigation.frame.maxY, width: self.view.frame.width, height: ScreenHeight-self.navigation.frame.maxY))
            }
        }
